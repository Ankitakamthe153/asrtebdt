const students = [
  ...
  function sortByGender() {
    ...
    displayTwoTables(maleStudents, femaleStudents);
  }
  
  function displayTwoTables(males, females) {
    const tablesDiv = document.getElementById('tables');
    tablesDiv.innerHTML = '';
  
    const maleTable = createTable('Male Students', males);
    const femaleTable = createTable('Female Students', females);
  ...
  function createTable(title, students) {
